                    ...
                    {isLoggedIn ? (
                        <div className='relative group'>
                            ...
                            <div className='absolute hidden group-hover:block top-6 right-0 pt-4'>
                                <button onClick={() => logout()} className=' bg-blue/20 border-2 border-blue/10 px-5 py-1.5 rounded text-white hover:bg-blue-600 hover:border-blue-600 hover:scale-105 transition-all duration-300'>
                                    Logout
                                </button>
                            </div>
                        </div>
