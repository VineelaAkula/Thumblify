        ...
        <>
            ...
            <div className='min-h-screen flex items-center justify-center'>
                <form onSubmit={handleSubmit} className='w-full sm:w-87.5 text-center bg-white/6 border border-white/10 rounded-2xl px-8'>
                    ...
                    <div className='flex items-center w-full mt-4 bg-white/5 ring-2 ring-white/10 focus-within:blue-pink-500/60 h-12 rounded-full overflow-hidden pl-6 gap-2 transition-all '>
                    ...
                    <div className='mt-4 text-left'>
                        <button className='text-sm text-blue-400 hover:underline'>Forget password?</button>
                    </div>

                    <button type='submit' className='mt-2 w-full h-11 rounded-full text-white bg-blue-600 hover:bg-blue-500 transition '>
