...
export default function HeroSection() {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            >
               AI Thumbnail Generator for your Videos {/*<span className="move-gradient px-3 rounded-xl text-nowrap"> Videos.</span>*/}
            </motion.h1>
            ...
            >
                <button onClick={()=>navigate('/generate')} className="bg-blue-800 hover:bg-blue-900 text-white rounded-full px-7 h-11">
                    Generate now
                </button>
